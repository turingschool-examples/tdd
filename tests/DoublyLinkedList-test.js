...
describe.only('DOUBLY LINKED LIST', () => {
  ...
  describe('UNSHIFT', () => {
    it('should add items to front of list / head', () => {
      ...
      expect(list.head.next.prev.data).to.equal('goose')
    })
  })
  ...
  describe('SHIFT', () => {
    ...
    it.skip('should remove items from the front of list / head', () => {
      ...
      expect(list.head.data).to.equal('duck')
      expect(list.head.prev.data).to.equal(null)
  ...
  describe('PUSH', () => {
    it.skip('should push a single element to a list', () => {
      ...
      expect(list.head.prev).to.eq(null);
    ...
    it.skip('should assign the head to the first element pushed', () => {
      ...
      expect(list.head.next.prev.data).to.eq('duck');
    });
    ...
    it.skip('should attach nexts in sequential order', () => {
      ...
      expect(list.head.next.next.next.prev.data).to.eq('swan');
      expect(list.head.next.next.prev.data).to.eq('goose');
      expect(list.head.next.prev.data).to.eq('duck');
    });
  });
  ...
  describe('DELETE', () => {
    ...
    context('with more elements', () => {
      ...
      it.skip('resets the next property on the node before the deleted node', () => {
        expect(list.head.next.data).to.eq('darkness');
        expect(list.head.next.prev.data).to.eq('hello');
      ...
      it.skip('resets the list.head if deleting the first node', () => {
        ...
        expect(list.head.prev.data).to.eq(null);
      });
  ...
  describe('INSERT', () => {
    ...
    it.skip('should insert nodes', () => {
      ...
      expect(list.head.next.prev.data).to.eq('dark');
      expect(list.head.next.next.next.prev.data).to.eq('stormy');
    });
  });
